...
bool UBlueprintJsonObject::GetInteger(FString Key, int32& Value) {
	...
	try
	{
		Value = mJsonObject->GetNumberField(Key);
		return true;
	} catch (...)
	{
		return false;
...
bool UBlueprintJsonObject::GetFloat(FString Key, float& Value) {
	...
	try
	{
		double Number = mJsonObject->GetNumberField(Key);
		Value = Number;
		return true;
	} catch (...)
	{
...
bool UBlueprintJsonObject::HasObject(FString Key) {
	return mJsonObject->HasTypedField<EJson::Object>(Key);
}
...
bool UBlueprintJsonObject::GetObject(FString Key, UBlueprintJsonObject*& Value) {
	...
	try
	{
		Value = UBlueprintJsonObject::FromSharedPointer(mJsonObject->GetObjectField(Key));
		return true;
	} catch (...)
	{
		return false;
