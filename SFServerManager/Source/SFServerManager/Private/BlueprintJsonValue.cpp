...
TArray<UBlueprintJsonValue*> UBlueprintJsonValue::CreateArray() {
	TArray<UBlueprintJsonValue*> NewArray;
	return NewArray;
}
...
bool UBlueprintJsonValue::ToFloat(float& Value) {
	...
	//try
	//{
	//	double Number = mJsonValue->AsNumber();
	//	Value = Number;
	//	return true;
	//} catch (...)
	//{
...
TArray<UBlueprintJsonValue*> UBlueprintJsonValue::ToObjectArray(TArray<UBlueprintJsonObject*> Values) {
	TArray<UBlueprintJsonValue*> vals;
	for (UBlueprintJsonObject* Value : Values) {
		vals.Add(UBlueprintJsonValue::FromObject(Value));
	}
