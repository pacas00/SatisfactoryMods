...
class SFSERVERMANAGER_API UBlueprintJsonValue : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Create Array", Keywords = "Json Create Array", ShortTooltip = "Creates an empty Json Array"), Category = "Json|Array")
	static TArray<UBlueprintJsonValue*> CreateArray();
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Object Array To Json Array", Keywords = "Json Object Array To Array", ShortTooltip = "Converts an Array of JsonObjects to a JsonArray of JsonObjects"), Category = "Json|Array")
	static TArray<UBlueprintJsonValue*> ToObjectArray(TArray<UBlueprintJsonObject*> Values);
};
