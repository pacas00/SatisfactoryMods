...
class SFSERVERMANAGER_API UBlueprintJsonObject : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Has Value", Keywords = "Json Has Value", ShortTooltip = "Does the Json Object have this key?"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Value", Keywords = "Json Set Value", ShortTooltip = "Sets a certain value without specifying its type (can be any)"), Category = "Json|Object")
	UBlueprintJsonObject* SetValue(FString Key, UBlueprintJsonValue* Value);

	// Deletes a Json value from a Json Object
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Delete Value", Keywords = "Json Delete Value", ShortTooltip = "Deletes a Json value from a Json Object"), Category = "Json|Object")
	UBlueprintJsonObject* DeleteValue(FString Key);
	
	// Does the Json Object have this key and is it a boolean?
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Has Boolean", Keywords = "Json Has Boolean", ShortTooltip = "Does the Json Object have this key and is it a boolean?"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Boolean", Keywords = "Json Set Boolean", ShortTooltip = "Sets a certain boolean as value in the Json Object"), Category = "Json|Object")
	UBlueprintJsonObject* SetBoolean(FString Key, bool Value);


	// Does the Json Object have this key and is it an integer?
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Has Integer", Keywords = "Json Has Integer", ShortTooltip = "Does the Json Object have this key and is it an integer?"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Integer", Keywords = "Json Set Integer", ShortTooltip = "Sets a certain integer as value in the Json Object"), Category = "Json|Object")
	UBlueprintJsonObject* SetInteger(FString Key, int32 Value);


	// Does the Json Object have this key and is it a float?
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Has Float", Keywords = "Json Has Float", ShortTooltip = "Does the Json Object have this key and is it a float?"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Float", Keywords = "Json Set Float", ShortTooltip = "Sets a certain float as value in the Json Object"), Category = "Json|Object")
	UBlueprintJsonObject* SetFloat(FString Key, float Value);


	// Does the Json Object have this key and is it a string?
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Has String", Keywords = "Json Has String", ShortTooltip = "Does the Json Object have this key and is it a string?"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set String", Keywords = "Json Set String", ShortTooltip = "Sets a certain string as value in the Json Object"), Category = "Json|Object")
	UBlueprintJsonObject* SetString(FString Key, FString Value);


	// Does the Json Object have this key and is it a Json Object
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Has Object", Keywords = "Json Has Object", ShortTooltip = "Does the Json Object have this key and is it another Json Object?"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Object", Keywords = "Json Get Object", ShortTooltip = "Gets a certain Json Object from the Json Object"), Category = "Json|Object")
	bool GetObject(FString Key, UBlueprintJsonObject*& Value);

	// Sets a Json Object as child of another Json Object
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Object", Keywords = "Json Set Object", ShortTooltip = "Sets a Json Object as child of another Json Object"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Has Array", Keywords = "Json Has Array", ShortTooltip = "Does the Json Object have this key and is it a Json Array?"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Array", Keywords = "Json Get Array", ShortTooltip = "Gets a certain Json Array from the Json Object without specifying a type"), Category = "Json|Object")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set Array", Keywords = "Json Set Array", ShortTooltip = "Sets a certain Json Array as value in a Json Object without specifying a type"), Category = "Json|Object")
